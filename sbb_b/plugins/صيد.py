# by: t.me/Drago_dr  ~ t.me/lsbax_dev
...
async def _(event):
    await event.edit(
        """
 ‹ اوامر الصيد الخاصة بسورس دراكو › 
        ...
        try:
            ch = await sbb_b(
                functions.channels.CreateChannelRequest(
                    title="‹ DRAGO HUNTER - صيد دراكو ›",
                    about="This channel to hunt username by - @Drago_dr ",
                )
            )
