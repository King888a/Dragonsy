...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("تنصيب دراكـو", "https://t.me/Drago_dr"),
                Button.url(
                    "مساعدة ❓",
        ...
        buttons = [
            [
                Button.url("• السورس •", "https://t.me/Drago_dr"),
            ],
            [
